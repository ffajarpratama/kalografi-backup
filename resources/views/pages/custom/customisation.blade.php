...
@section('content')
    ...
    <script>
        ...
        function calculate() {
            const photographerSelectedId = document.forms['total_form'].elements['photographer'].options[document.forms['total_form'].elements['photographer'].selectedIndex].getAttribute('data-bs-harga-photo');
            const videographerSelectedId = document.forms['total_form'].elements['videographer'].options[document.forms['total_form'].elements['videographer'].selectedIndex].getAttribute('data-bs-harga-video');
            const printedPhotoSelectedId = document.forms['total_form'].elements['printedphoto'].options[document.forms['total_form'].elements['printedphoto'].selectedIndex].getAttribute('data-bs-harga-pp');
            const printedPhotoQty = document.getElementById("print_quantity").value;
            const photoBookSelectedId = document.forms['total_form'].elements['photobook'].options[document.forms['total_form'].elements['photobook'].selectedIndex].getAttribute('data-bs-harga-pb');
            ...
            total_price = photographerPrice + videographerPrice + printedPhotoPrice * printedPhotoQty + photoBookPrice * photoBookQty + additionalPrice;
