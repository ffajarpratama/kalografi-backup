            ...
            <div class="row row-cols-1 row-cols-md-3">
                <div class="col">
                    <div class="card border-0 shadow-sm" style="border-radius: 20px;">
                        <img src="{{ asset('placeholders/mahesa.png') }}" class="card-img-top" alt="...">
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="row justify-content-center mb-3">
                                <div class="col-md-6 text-kalografi">
                                    <a href='javascript:;' onclick="alert1();" class="btn btn-kalografi btn-sm"
                                        style="display: block;">
                                        Book Now
                                    </a>
                                </div>
                ...
                <div class="col">
                    <div class="card border-0 shadow-sm" style="border-radius: 20px;">
                        <img src="{{ asset('placeholders/manendra.png') }}" class="card-img-top" alt="...">
                        <div class="card-body">
                            <div class="row">
                                <div class="card-title text-center my-2">
                                    <h4 class="semi-bold text-secondary" style="letter-spacing: -0.5px">
                ...
                <div class="col">
                    <div class="card border-0 shadow-sm" style="border-radius: 20px;">
                        <img src="{{ asset('placeholders/mahawira.png') }}" class="card-img-top" alt="...">
                        <div class="card-body">
                            <div class="row">
                                <div class="card-title text-center my-2">
                                    <h4 class="semi-bold text-secondary" style="letter-spacing: -0.5px">
                            ...
                            <div class="row justify-content-center mb-3">
                                <div class="col-md-6 text-kalografi">
                                    <a href="{{ route('pricelist.wedding.show') }}" class="btn btn-kalografi btn-sm"
                                        style="display: block;">
                                        Book Now
                                    </a>
                                </div>
