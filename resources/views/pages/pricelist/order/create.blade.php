                        ...
                        <div class="mb-5">
                            ...
                            <div class="row ps-4 mb-3">
                                ...
                                <div class="form-check form-check-inline px-0">
                                    ...
                                    <label class="btn btn-check-kalografi mb-1" for="warm" style="width: 8rem;">Warm</label>
                                    ...
                                    <label class="btn btn-check-kalografi mb-1" for="light&airy" style="width: 8rem;">Light
                                        & Airy</label>
                                </div>
                                <div class="form-check form-check-inline mb-3 px-0">
                                    <input type="radio" class="btn-check" name="tone" id="film_look"
                                        onchange="changetonevalue()" value="Film Look">
                                    <label class="btn btn-check-kalografi mb-1" for="film_look" style="width: 8rem;">Film
                                        Look</label>
