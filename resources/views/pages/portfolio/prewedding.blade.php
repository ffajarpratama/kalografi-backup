<div class="container-fluid py-5" style="background-color: #FAFBFA">
    <div class="row text-center justify-content-center">
        <h3 class="semi-bold fs-1 mb-3" style="color: #8F9C69; letter-spacing: -1px;">Featured Pre-Wedding</h3>
    ...
    <div class="row">
        <div id="preWeddingCarousel" class="carousel slide carousel-dark" data-bs-ride="carousel">
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#preWeddingCarousel" data-bs-slide-to="0"
                        class="active" aria-current="true" aria-label="Slide 1"></button>
                <button type="button" data-bs-target="#preWeddingCarousel" data-bs-slide-to="1"
                        aria-label="Slide 2"></button>
                <button type="button" data-bs-target="#preWeddingCarousel" data-bs-slide-to="2"
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-4 mb-5 mx-4">
                            <div class="col">
                                <div class="card border-0">
                                    <img src="{{ asset('placeholders/portfolio-carousel-1.jpg') }}"
                                         class="rounded" alt="...">
                                    <div class="card-body" style="background-color: #FAFBFA">
                                        <div class="row mb-4">
                                            <div class="card-title text-center my-2">
                                                <h6 class="mb-0 semi-bold text-secondary" style="letter-spacing: -0.5px">
                                                    Pre-Wedding R & E :<br>
                                                    Calm and Nature Outlook in Bromo
                                                </h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row justify-content-center mb-4 mx-3">
                                            ...
                                            <div class="col-md-4 text-center">
                                                <a href="#" class="btn btn-sm text-bold btn-tags">Casual</a>
                                            </div>
                                            <div class="col-md-4 text-center">
                                                <a href="#" class="btn btn-sm text-bold btn-tags">Moody</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body" style="background-color: #FAFBFA">
                                        <div class="row mb-4">
                                            <div class="card-title text-center my-2">
                                                <h6 class="mb-0 semi-bold text-secondary" style="letter-spacing: -0.5px">
                                                    Pre-Wedding R & B :<br>
                                                    Light and Airy Sunset in Jepara
                                                </h6>
                                            </div>
                                        </div>
